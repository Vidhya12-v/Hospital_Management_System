      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
             ...
             <li><a class="active" href="${pageContext.request.contextPath}/User_Home">Home</a></li>
                   <li> <a href="${pageContext.request.contextPath}/View_Doctor">View Doctor</a></li>
                   <li> <a href="${pageContext.request.contextPath}/View_Bed">View Bed</a></li>
                  <li>  <a href="${pageContext.request.contextPath}/View_Booked_Doctor">Doctor Appointment</a></li>
                    <li> <a href="${pageContext.request.contextPath}/View_Booked_Bed">Bed Booked</a></li>
                   <li>  <a href="${pageContext.request.contextPath}/Nearby_Hospital">Emergency</a></li>
