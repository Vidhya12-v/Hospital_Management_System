      ...
      <div class="container position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
          <ul>
             ...
             <li><a class="active" href="${pageContext.request.contextPath}/Admin_Home">Home</a></li>
                  <li>  <a href="${pageContext.request.contextPath}/addDoctor">Add Doctor</a></li>
                        <li>   <a href="${pageContext.request.contextPath}/addBed">Add Bed</a></li>
                          <li> <a href="${pageContext.request.contextPath}/viewAppointments">View Patient Appointments</a></li>
                       <li>    <a href="${pageContext.request.contextPath}/viewBedBookings">View Bed Booking</a></li>
