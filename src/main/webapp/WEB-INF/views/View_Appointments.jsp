...
<div class="appointments-section">
    <h2 class="header-title">Requested Appointments</h2>
    <div class="appointments-grid">
        <c:forEach var="app" items="${pendingAppointments}">
            <div class="appointment-card">
                <div class="appointment-info">
                    <p><i class="fas fa-user-md"></i> <b>Doctor:</b> ${app.doctorName} (${app.doctorSpecialization})</p>
                ...
                <div class="actions">
                    <form action="${pageContext.request.contextPath}/updateAppointmentStatus" method="post" style="display:inline;">
...
<div class="appointments-section">
    <h2 class="header-title">Approved Appointments</h2>
    <div class="appointments-grid">
        <c:forEach var="app" items="${approvedAppointments}">
            <div class="appointment-card">
                <div class="appointment-info">
                    <p><i class="fas fa-user-md"></i> Doctor: ${app.doctorName} (${app.doctorSpecialization})</p>
                    <p><i class="fas fa-user"></i> Patient: ${app.userName}</p>
                    <p><i class="fas fa-calendar-alt"></i> Date: ${app.appointmentDate}</p>
                    <p><i class="fas fa-clock"></i> Time: ${app.appointmentTime}</p>
                </div>
...
<div class="appointments-section">
    <h2 class="header-title">Rejected Appointments</h2>
    <div class="appointments-grid">
        <c:forEach var="app" items="${rejectedAppointments}">
            <div class="appointment-card">
                <div class="appointment-info">
                    <p><i class="fas fa-user-md"></i> Doctor: ${app.doctorName} (${app.doctorSpecialization})</p>
                    <p><i class="fas fa-user"></i> Patient: ${app.userName}</p>
